...
function ShowCategories(obj) {
  ...
  var dbPageCat = new DashboardCategories(CityId);
  ko.applyBindings(dbPageCat, $('#dashboardcategories')[0]);
}
//Pages
...
$(document).ready(function () {
  ...
  ko.applyBindings(dbPage, $('#home')[0]);

  //var dbPageCat = new DashboardCategories(1);
  //ko.applyBindings(dbPageCat, $('#dashboardcategories')[0]);

  //var dbPageBlk = new DashboardBlocks(2, 1);
  //ko.applyBindings(dbPageBlk, $('#dashboardblocks')[0]);
